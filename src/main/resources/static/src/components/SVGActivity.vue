<template>
  ...
  <g v-bind:x="activity.x" v-bind:y="activity.y" fill="none" stroke="#000">
    ...
    <g x="0" y="0" fill="none" stroke="#000" id="Task_1_LABEL" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
      <text v-bind:x="x+50" v-bind:y="y+50" text-anchor="middle" font="10px 'serif'" stroke="none" fill="#000000" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: middle; font-style: normal; font-variant: normal; font-weight: normal; font-stretch: normal; font-size: 12px; line-height: normal; font-family: serif; cursor: move; background-color: rgb(255, 255, 255);" fill-r="1" fill-cx="0.1" fill-cy="0.1" fill-opacity="1" stroke-width="1.2" r="10" font-size="12px" id="Task_1_LABELFO">
        <tspan dy="3.75" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
          {{ activity.name.text }}
        </tspan>
      </text>
    </g>
    <image v-bind:x="x" v-bind:y="y" width="20" height="20" preserveAspectRatio="none" title="undefined" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/static/image/symbol/User.png" text-anchor="middle" id="OG_1239_281" _index="0" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: middle;"></image>
    {{path}}
  </g>
