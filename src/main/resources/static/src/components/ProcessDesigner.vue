        ...
        <form novalidate @submit.stop.prevent="submit">
            ...
            <md-tabs>
                    ...
                    <md-layout md-gutter>
                        <md-layout md-flex="70">
                            <div style="overflow: scroll; width:500" v-if="definition && definition.childActivities[1]">
                                <svg height="1448" version="1.1" width="1704" xmlns="http://www.w3.org/2000/svg"
                                     xmlns:xlink="http://www.w3.org/1999/xlink"
                                     style="overflow: hidden; position: relative; background-color: rgb(247, 247, 247); user-select: none; background-image: url(&quot;/static/image/grid.gif&quot;);"
                                     id="OG_5264">

                                    <component :is="getSVGComponentName(child)"
                                               v-for="child in definition.childActivities[1]" :activity="child"
                                               :x="child.x" :y="child.y"
                                               v-on:click.native="showProperties(child)"></component>
                                </svg>
                            </div>
                        </md-layout>
                ...
                <md-tab id="data" md-label="프로세스 변수" v-if="definition">
                    <object-grid java="org.uengine.kernel.ProcessVariable" :online="false"
                                 :data="definition.processVariableDescriptors" :full-fledged="true">
                    </object-grid>
                </md-tab>
