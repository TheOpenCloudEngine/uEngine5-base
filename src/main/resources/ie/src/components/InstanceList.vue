  ...
  export default {
    ...
    mounted() {
      ...
      serviceLocator.invoke({
        ...
        success: function (data) {
          var instances = [];
          if (data._embedded && data._embedded.instances && data._embedded.instances.length) {
            $.each(data._embedded.instances, function (i, instance) {
    ...
    methods: {
      move: function (instId) {
        ...
        window.location.href = '/instance/' + instId;
      }
    }
  }
</script>
