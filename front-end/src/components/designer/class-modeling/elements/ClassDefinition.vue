  ...
  <div>
    ...
    >
      <template slot="properties-contents">
        ...
        <md-switch v-model="reference">Reference from other model (Bounded Context)</md-switch>
        ...
        <div v-if="!reference">
          ...
          <md-layout v-for="attribute in value.fieldDescriptors">
            <md-layout>
              <md-checkbox v-model="attribute.attributes.isKey">pk</md-checkbox>
              <md-input-container>
        ...
        <div v-else>
          ...
          <md-button @click="updateClassInfo">Update class info</md-button>
        </div>
